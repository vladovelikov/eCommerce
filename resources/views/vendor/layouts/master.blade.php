...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('frontend/assets/images/favicon.png')}}images/favicon.png">
...
<!--slick slider js-->
<script src="{{asset('frontend/assets/js/slick.min.js')}}js/slick.min.js"></script>
<!--simplyCountdown js-->
...
<!--sticky sidebar js-->
<script src="{{asset('frontend/assets/js/sticky_sidebar.js')}}js/sticky_sidebar.js"></script>
<!--price ranger js-->
